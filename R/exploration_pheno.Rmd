...
dt_rendement <- rbind(aviso_rendment, montego_rendment) |> 
  select(-N)

```

MAD14, R2N14, SYN14, EUR14
BGA15, INRAE15, LE15, R2N15, SYN15, TI15, MAD15  



# Plot SN, SY, TSW pour variété
```{r}
...
SN	Spike Number → nombre d’épis par plante ou par unité de surface OU Seed Number
